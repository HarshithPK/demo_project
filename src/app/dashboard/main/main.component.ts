    ...
    getAllFroms() {
        ...
        this.http.get(url).subscribe((res: any) => {
            ...
            this.forms.forEach((form, index) => {
                if (form.approval.divisional_head.isApproved) {
                    this.approvedFroms++;
                } else if (
                    form.approval.authorization_of_area_inChange.isApproved ||
                    form.approval.authorization_of_maintenance.isApproved ||
                    form.approval.factory_manager.isApproved ||
                    form.approval.safety_officer.isApproved ||
                    form.approval.security_personal.isApproved ||
                    form.approval.work_initiator.isApproved ||
                    form.approval.work_receiver.isApproved
                ) {
                    this.approvalPendingForms++;
                }
                ...
                if (
                    ...
                    form.approval.work_initiator.isApproved &&
                    form.approval.work_receiver.isApproved &&
                    form.approval.divisional_head.isApproved
                ) {
                    this.completed++;
                }
            });
        ...
        this.areaChartPlugins = [
            {
                afterLayout: (chart) => {
                    ...
                    const gradientStroke2 = ctx.createLinearGradient(
                        0,
                        0,
                        0,
                        150
