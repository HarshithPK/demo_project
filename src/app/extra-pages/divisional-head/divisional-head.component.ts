...
@Component({
    selector: "app-divisional-head",
    templateUrl: "./divisional-head.component.html",
    styleUrls: ["./divisional-head.component.scss"],
})
export class DivisionalHeadComponent implements OnInit {
    forms;
    name = "";
