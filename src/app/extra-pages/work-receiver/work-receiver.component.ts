...
@Component({
    selector: "app-work-receiver",
    templateUrl: "./work-receiver.component.html",
    styleUrls: ["./work-receiver.component.scss"],
})
export class WorkReceiverComponent implements OnInit {
    forms;
    name = "";
