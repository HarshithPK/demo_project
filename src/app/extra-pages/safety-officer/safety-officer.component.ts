...
@Component({
    ...
    templateUrl: "./safety-officer.component.html",
    styleUrls: ["./safety-officer.component.scss"],
})
export class SafetyOfficerComponent implements OnInit {
    forms;
    name = "";
